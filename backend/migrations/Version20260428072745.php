 ...
 */
final class Version20260428072745 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE uv ADD nombre_plant_par_plateau INT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE uv DROP nombre_plant_par_plateau');
    }
}
